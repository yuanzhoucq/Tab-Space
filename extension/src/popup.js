(function () {
  ...
  const strings = zh ? {
    ...
    connectHelp: "打开 Mac 上的 Tab Space，在主界面点击“浏览器配对码”，然后输入六位数字。",
    connect: "连接",
    ...
    connectHelp: "Open Tab Space on your Mac, click Browser Pairing Code in the main window, then enter the six-digit code.",
    connect: "Connect",
