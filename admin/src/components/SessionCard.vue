  ...
  <div :class="embedded ? 'embedded-session' : 'session'"
    ...
    <div v-if="!embedded" class="session-header">
      ...
      <div class="session-header-right">
        ...
        <button v-if="aiEnabled" type="button" class="btn ai-btn" data-testid="ai-enhance-session"
        ...
        <button v-if="aiEnabled && session.sites.length >= 3" type="button" class="btn split-btn" data-testid="ai-split-session"
